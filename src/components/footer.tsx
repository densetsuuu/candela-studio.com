...
export function Footer() {
    return (
        <footer
            className="w-full grid place-items-center mt-20 xl:mt-0 text-muted-foreground bg-white border-t dark:bg-gray-950 dark:text-gray-400"
            id="page-footer">
            <div
                className="px-10 py-4 flex flex-col gap-4 md:gap-0 md:flex-row items-center justify-between w-full h-20">
