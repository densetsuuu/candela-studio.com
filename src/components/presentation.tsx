...
export function Presentation() {
    return (
        <div className="flex flex-col text-center items-center gap-3">
            <h1
                className="max-w-96 md:max-w-200 font-heading mt-48 md:mt-24
            ...
            <p className="font-bold text-md sm:text-base lg:text-xl mb-6 sm:mb-8 md:mb-12 mx-auto max-w-2xl text-gray-700 dark:text-gray-300 p-3 sm:p-4">
                Nous sommes une agence de développement web qui créé des expériences numériques innovantes et
                accessibles
                pour
